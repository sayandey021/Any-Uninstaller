...
#define MyAppName          "Any Uninstaller"
#define MyAppNameShort     "AnyUninstaller"
#define MyAppPublisher     "Marcin Szeniak"
#define MyAppURL           "https://github.com/AnyUninstaller/AnyUninstaller"
#define MyAppExeName       "AnyUninstaller.exe"
...
Source: "{#InputDir}\AnyU_manual.html";          DestDir: "{app}"; Components: main; Flags: ignoreversion isreadme; Check: IsPortable or not IsPortable
...
[InstallDelete]
Name: {app}\AnyU-launcher.exe; Type: files
...
[UninstallDelete]
; Remove files generated by AnyU itself. Installed files are removed automatically by Inno Setup.
Type: files; Name: "{app}\CleanLogs.bat"
Type: files; Name: "{app}\AnyUninstaller.settings"
...
//  begin
//    Cmd := '/C del /f /s AnyUninstaller.exe.log SteamHelper.exe.log StoreAppHelper.exe.log UninstallerAutomatizer.exe.log UpdateHelper.exe.log';
//    Exec(ExpandConstant('{cmd}'), Cmd, MicrosoftPath, SW_HIDE, ewWaitUntilTerminated, ResultCode);
//  end;
//
//  // Remove settings directories created by .NET under %LOCALAPPDATA%\\Marcin_Szeniak\\AnyUninstaller*
//  SettingsDir := AppDataSafe + '\\Marcin_Szeniak';
//  if DirExists(SettingsDir) then
//  begin
//    // Remove matching directories
//    Cmd := '/C for /d %G in ("' + SettingsDir + '\\AnyUninstaller*") do rd /s /q "%G"';
