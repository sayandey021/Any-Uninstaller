...
namespace AnyUninstaller.Functions.Tools
{
    internal static class UpdateGrabber
    {
        ...
        public static string LatestReleaseUrl = "https://github.com/AnyUninstaller/AnyUninstaller/releases/latest";

        public static Version CheckLatestVersion()
        {
            // Should result in something like "https://github.com/AnyUninstaller/AnyUninstaller/releases/tag/v4.1"
