...
namespace AnyUninstaller.Forms
{
    partial class SettingsWindow
    {
        ...
        private void InitializeComponent()
        {
            ...
            propertiesSidebar1 = new AnyUninstaller.Controls.PropertiesSidebar();
            tabPageInterface = new TabPage();
            groupBoxLanguage = new GroupBox();
            tabPageUninstallation = new TabPage();
            uninstallationSettings1 = new AnyUninstaller.Controls.UninstallationSettings();
            ...
            cacheSettings1 = new AnyUninstaller.Controls.Settings.CacheSettings();
