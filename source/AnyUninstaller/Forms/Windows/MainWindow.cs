...
using AnyUninstaller.Functions;
using AnyUninstaller.Functions.ApplicationList;
...
namespace AnyUninstaller.Forms
{
    internal sealed partial class MainWindow : Form
    {
        ...
        {
            //uninstallAnyUninstallToolstripMenuItem.Visible = Program.IsInstalled;
            uninstallAnyUninstallToolstripMenuItem.Enabled = Program.IsInstalled;
        }
        ...
        private void uninstallAnyUninstallToolstripMenuItem_Click(object sender, EventArgs e)
        {
                ...
                if (d.ShowDialog() == DialogResult.OK)
                {
                    try
                    {
                        File.WriteAllLines(d.FileName,
                            new[] { "@echo off", "echo AnyU Generated batch uninstall script" }.Concat(
                            _listView.SelectedUninstallers
        ...
        private void editCustomNoteMenuItem_Click(object sender, EventArgs e)
        {
            ...
            using (var dialog = new AnyUninstaller.Forms.CustomNoteDialog(title, existingNote))
            {
